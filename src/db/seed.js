...
const categories = [
  {
    ...
    description:
      'Пішохідні та велосипедні маршрути мальовничими куточками України.',
  },
  {
    category: 'eco-tips',
    title: 'Еко-поради',
...
const stories = [
  {
    ...
    category: 'routes',
    article:
      'Маршрут веде через букові праліси, гірські полонини та мальовничі водоспади, відкриваючи неповторні краєвиди Карпат.',
    rate: 5,
  },
  {
    img: 'https://ac.goit.global/fullstack/react/nature-2.jpg',
    ...
    category: 'eco-tips',
    article:
      'Як подорожувати, не завдаючи шкоди природі: сортування сміття, вибір маршрутів та підтримка місцевих громад.',
    rate: 5,
  },
  {
    img: 'https://ac.goit.global/fullstack/react/nature-3.jpg',
    ...
    category: 'nature',
    article:
      'Шацький національний природний парк вражає розмаїттям флори і фауни та кришталево чистими озерами.',
    rate: 9,
  },
  {
    img: 'https://ac.goit.global/fullstack/react/nature-4.jpg',
    ...
    category: 'culture',
    article:
      'Знайомство з давніми ремеслами гуцулів: різьбою по дереву, гончарством та ткацтвом.',
    rate: 6,
  },
  {
    img: 'https://ac.goit.global/fullstack/react/nature-5.jpg',
    ...
    category: 'local-products',
    article:
      'Огляд автентичних продуктів гірських господарств, які варто скуштувати під час подорожі.',
    rate: 7,
  },
];
...
const seed = async () => {
  ...
  try {
    ...
    console.log(
      `Seeded ${categories.length} categories and ${stories.length} stories for user ${seedUser.email}`,
    );
  } catch (error) {
